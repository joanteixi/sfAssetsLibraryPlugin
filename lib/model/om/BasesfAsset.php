...
abstract class BasesfAsset extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the description_antic field.
	 * @var        string
	 */
	protected $description_antic;
	...
	/**
	 * @var        array SfAssetI18n[] Collection to store aggregation of SfAssetI18n objects.
	 */
	protected $collSfAssetI18ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collSfAssetI18ns.
	 */
	private $lastSfAssetI18nCriteria = null;
	...
	/**
	 * Get the [description_antic] column value.
	 * 
	 * @return     string
	 */
	public function getDescriptionAntic()
	{
		return $this->description_antic;
	}
	...
	/**
	 * Set the value of [description_antic] column.
	 * 
	 * @param      string $v new value
	 * @return     sfAsset The current object (for fluent API support)
	 */
	public function setDescriptionAntic($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->description_antic !== $v) {
			$this->description_antic = $v;
			$this->modifiedColumns[] = sfAssetPeer::DESCRIPTION_ANTIC;
		}
	...
	public function setRank($v)
	{
		...
		if ($this->rank !== $v) {
			$this->rank = $v;
			$this->modifiedColumns[] = sfAssetPeer::RANK;
		}
	...
	public function setIsPublic($v)
	{
		...
		if ($this->is_public !== $v) {
			$this->is_public = $v;
			$this->modifiedColumns[] = sfAssetPeer::IS_PUBLIC;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->description_antic = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			return $startcol + 11; // 11 = sfAssetPeer::NUM_COLUMNS - sfAssetPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->asfAssetFolder = null;
			$this->collSfAssetI18ns = null;
			$this->lastSfAssetI18nCriteria = null;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				return $this->getDescriptionAntic();
				break;
			case 4:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getDescriptionAntic(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				$this->setDescriptionAntic($value);
				break;
			case 4:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setDescriptionAntic($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfAssetPeer::DESCRIPTION_ANTIC)) $criteria->add(sfAssetPeer::DESCRIPTION_ANTIC, $this->description_antic);
		...
		if ($this->isColumnModified(sfAssetPeer::RANK)) $criteria->add(sfAssetPeer::RANK, $this->rank);
		if ($this->isColumnModified(sfAssetPeer::IS_PUBLIC)) $criteria->add(sfAssetPeer::IS_PUBLIC, $this->is_public);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDescriptionAntic($this->description_antic);
	...
	/**
	 * Clears out the collSfAssetI18ns collection (array).
	 *
	 ...
	 * @see        addSfAssetI18ns()
	 */
	public function clearSfAssetI18ns()
	{
		$this->collSfAssetI18ns = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collSfAssetI18ns collection (array).
	 *
	 * By default this just sets the collSfAssetI18ns collection to an empty array (like clearcollSfAssetI18ns());
	...
	/**
	 * Gets an array of SfAssetI18n objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfAsset has previously been saved, it will retrieve
	 * related SfAssetI18ns from storage. If this sfAsset is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array SfAssetI18n[]
	 * @throws     PropelException
	 */
	public function getSfAssetI18ns($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfAssetPeer::DATABASE_NAME);
		}
	...
	/**
	 * Returns the number of related SfAssetI18n objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related SfAssetI18n objects.
	 * @throws     PropelException
	 */
	public function countSfAssetI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfAssetPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collSfAssetI18ns === null) {
			if ($this->isNew()) {
				...
				$count = SfAssetI18nPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastSfAssetI18nCriteria) || !$this->lastSfAssetI18nCriteria->equals($criteria)) {
					...
					$count = count($this->collSfAssetI18ns);
				}
			} else {
				$count = count($this->collSfAssetI18ns);
			}
	...
	{
		if ($this->collSfAssetI18ns === null) {
			$this->initSfAssetI18ns();
		}
		if (!in_array($l, $this->collSfAssetI18ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collSfAssetI18ns, $l);
			$l->setsfAsset($this);
		}
	}
	...
	{
		if ($deep) {
			if ($this->collSfAssetI18ns) {
				foreach ((array) $this->collSfAssetI18ns as $o) {
	...
	/**
	 * Returns the "description" value from the current {@link SfAssetI18n}.
	 */
	public function getDescription($culture = null)
	{
	  return $this->getCurrentSfAssetI18n($culture)->getDescription();
	}
	
	/**
	 * Sets the "description" value of the current {@link SfAssetI18n}.
	 *
	 * @return sfAsset
	 */
	public function setDescription($value, $culture = null)
	{
	  $this->getCurrentSfAssetI18n($culture)->setDescription($value);
	  return $this;
	}
	 ...
	 * @return SfAssetI18n
	 */
	public function getCurrentSfAssetI18n($culture = null)
	{
	  if (null === $culture)
	  {
	  ...
	  {
	    $object = $this->isNew() ? null : SfAssetI18nPeer::retrieveByPK($this->getPrimaryKey(), $culture);
	    if ($object)
	    {
	      $this->setSfAssetI18nForCulture($object, $culture);
	    }
	    else
	    {
	      $this->setSfAssetI18nForCulture(new SfAssetI18n(), $culture);
	 ...
	 */
	public function setSfAssetI18nForCulture(SfAssetI18n $object, $culture)
	{
