...
abstract class BaseSfAssetI18n extends BaseObject  implements Persistent {
	 ...
	 * @return     SfAssetI18n The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->description = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->asfAsset !== null && $this->id !== $this->asfAsset->getId()) {
			$this->asfAsset = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SfAssetI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$con->commit();
				SfAssetI18nPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->asfAsset !== null) {
				if ($this->asfAsset->isModified() || ($this->asfAsset->getCulture() && $this->asfAsset->getCurrentSfAssetI18n()->isModified()) || $this->asfAsset->isNew()) {
	 ...
	 * @throws     PropelException
	 */
	public function setsfAsset(sfAsset $v = null)
	{
		if ($v === null) {
			$this->setId(NULL);
		} else {
		...
		// If this object has already been added to the sfAsset object, it will not be re-added.
		if ($v !== null) {
			$v->addSfAssetI18n($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getsfAsset(PropelPDO $con = null)
	{
		if ($this->asfAsset === null && ($this->id !== null)) {
			$this->asfAsset = sfAssetPeer::retrieveByPk($this->id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfAsset->addSfAssetI18ns($this);
			 */
		}
